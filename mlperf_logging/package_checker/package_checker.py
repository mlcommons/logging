...
def check_training_result_files(folder, usage, ruleset, quiet, werror,
    ...
    for system_folder in _get_sub_folders(result_folder):
        ...
        for benchmark_folder in benchmark_folders:
            ...
            if ruleset in {'1.0.0', '1.1.0', '2.0.0', '2.1.0', '3.0.0', '3.1.0', '4.0.0', '4.1.0', '5.0.0', '5.1.0', '6.0.0', '6.1.0'} and division == 'closed':
            ...
            if ruleset in {'1.0.0', '1.1.0', '2.0.0', '2.1.0', '3.0.0', '3.1.0', '4.0.0', '4.1.0', '5.0.0', '5.1.0', '6.0.0', '6.1.0'} and division == 'closed' and benchmark != 'minigo':
...
def check_training_package(folder, usage, ruleset, quiet, werror, rcp_bypass, rcp_bert_train_samples, seed_checker_bypass, log_output):
    ...
    """
    too_many_errors = False
    if ruleset in {'1.0.0', '1.1.0', '2.0.0', '2.1.0', '3.0.0', '3.1.0', '4.0.0', '4.1.0', '5.0.0', '5.1.0', '6.0.0', '6.1.0'}:
