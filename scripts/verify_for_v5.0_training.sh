...
python3 -m mlperf_logging.package_checker $1 training 5.0.0 $PACKAGE_CHECKER_PARAMS
python3 -m mlperf_logging.result_summarizer $1 training 5.0.0
python3 -m mlperf_logging.repo_checker $1 training 5.0.0
